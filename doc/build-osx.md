...
touch "/Users/${USER}/Library/Application Support/Litecoin/pricecoinx.conf"

chmod 600 "/Users/${USER}/Library/Application Support/Litecoin/pricecoinx.conf"
```
...
## Other commands:
```shell
./src/litecoind -daemon      # Starts the pricecoinx daemon.
