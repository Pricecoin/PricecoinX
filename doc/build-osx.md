...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, PricecoinX Core may be
...
The first time you run pricecoinxd, it will start downloading the blockchain. This process could
