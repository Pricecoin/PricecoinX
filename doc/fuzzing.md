...
with certain assembly code from Litecoin Core's code. See [developer notes on sanitizers](https://github.com/pricecoinx-project/pricecoinx/blob/master/doc/developer-notes.md#sanitizers)
