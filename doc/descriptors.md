...
Since PricecoinX Core v0.17, there is support for Output Descriptors in the
...
- Segwit addresses (bech32, of the form `prcx1...`, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
