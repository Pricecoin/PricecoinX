# Support for Output Descriptors in Pricecoinx Core

Since Pricecoinx Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `prcx1...` for mainnet or `tprcx1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Pricecoinx's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Pricecoinx Core wallets, a convenience function `combo` is
