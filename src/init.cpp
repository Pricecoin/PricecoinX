...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-port=<port>", strprintf("Listen for connections on <port> (default: %u or testnet: %u)", defauprcxhainParams->GetDefaultPort(), testnetChainParams->GetDefaultPort()), false, OptionsCategory::CONNECTION);
    ...
    gArgs.AddArg("-checkblockindex", strprintf("Do a full consistency check for mapBlockIndex, setBlockIndexCandidates, chainActive and mapBlocksUnlinked occasionally. (default: %u)", defauprcxhainParams->DefauprcxonsistencyChecks()), true, OptionsCategory::DEBUG_TEST);
    gArgs.AddArg("-checkmempool=<n>", strprintf("Run checks every <n> transactions (default: %u)", defauprcxhainParams->DefauprcxonsistencyChecks()), true, OptionsCategory::DEBUG_TEST);
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/ZachChan105/pricecoinx>";
    const std::string URL_WEBSITE = "<https://pricecoincrypto.com>";
