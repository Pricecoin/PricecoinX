...
bech32_templates = [
  ...
  ('prcx',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('prcx',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('prcx',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tprcx',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tprcx',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tprcx',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rprcx',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rprcx',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rprcx', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tprcx',  17, 32, False, False, False),
  ('rprcx',  3,  1, False, False, False),
  ('prcx',   15, 41, False, False, False),
  ('tprcx',  0, 16, False, False, False),
  ('rprcx',  0, 32, True,  False, False),
  ('prcx',   0, 16, True,  False, False),
  ('tprcx',  0, 32, False, True,  False),
  ('rprcx',  0, 20, False, False, True)
]
