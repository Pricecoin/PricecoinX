...
bech32_templates = [
  ...
  ('prcx',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('prcx',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('prcx',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('prcx',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tprcx',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tprcx',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tprcx',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tprcx',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tprcx',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tprcx',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tprcx',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tprcx',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rprcx',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rprcx',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rprcx',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rprcx', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tprcx',   17, 32, Encoding.BECH32M, False, False, False),
  ('rprcx',  3,  1, Encoding.BECH32M, False, False, False),
  ('prcx',   15, 41, Encoding.BECH32M, False, False, False),
  ('tprcx',    0, 16, Encoding.BECH32,  False, False, False),
  ('rprcx',  0, 32, Encoding.BECH32,  True,  False, False),
  ('prcx',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tprcx',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rprcx',  0, 20, Encoding.BECH32,  False, False, True),
  ('prcx',    0, 20, Encoding.BECH32M, False, False, False),
  ('tprcx',    0, 32, Encoding.BECH32M, False, False, False),
  ('rprcx',  0, 20, Encoding.BECH32M, False, False, False),
  ('prcx',    1, 32, Encoding.BECH32,  False, False, False),
  ('tprcx',    2, 16, Encoding.BECH32,  False, False, False),
  ('rprcx', 16, 20, Encoding.BECH32,  False, False, False),
]
