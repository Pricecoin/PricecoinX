...
This means one can have an always-on litecoind instance running, and another local litecoind/pricecoinx-qt instance which connects to this node and receives blocks from it.
