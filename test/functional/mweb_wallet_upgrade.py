#!/usr/bin/env python3
# Copyright (c) 2021 The PricecoinX Core developers
...
from test_framework.prcx_util import create_non_hd_wallet, setup_mweb_chain
...
class MWEBWalletUpgradeTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        #
        # Create a non-HD wallet using an older pricecoinx core version
        #
