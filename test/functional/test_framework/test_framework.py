...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    """Base class for a pricecoinx test script.

    Individual pricecoinx test scripts should subclass this class and override the set_test_params() and run_test() methods.
    ...
    def main(self):
        ...
        parser.add_argument("--usecli", dest="usecli", default=False, action="store_true",
                            help="use pricecoinx-cli instead of RPC for all commands")
        ...
        self.config = config
        self.options.bitcoind = os.getenv("PRICECOINXD", default=config["environment"]["BUILDDIR"] + '/src/pricecoinxd' + config["environment"]["EXEEXT"])
        self.options.bitcoincli = os.getenv("PRICECOINXCLI", default=config["environment"]["BUILDDIR"] + '/src/pricecoinx-cli' + config["environment"]["EXEEXT"])
    ...
    def skip_if_no_bitcoind_zmq(self):
        ...
        if not self.is_zmq_compiled():
            raise SkipTest("pricecoinxd has not been built with zmq enabled.")
    ...
    def skip_if_no_cli(self):
        ...
        if not self.is_cli_compiled():
            raise SkipTest("pricecoinx-cli has not been compiled.")
