...
"""Verify that starting pricecoinx with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pricecoinx with -h for help text")
        ...
        self.log.info("Start pricecoinx with -version for version information")
        ...
        self.log.info("Start pricecoinxd with -fakearg to make sure it does not start")
